...
and compares to goalkeepers random. There is up to 6 penaltys if you dont win before
"""    
     total_penalties = 0
     goalkeeper_scores = 0
     penalty_scores = 0
    ...
    while total_penalties < 6:
           ...
           os.system('cls' if os.name == 'nt' else 'clear')
            ...
            if user_option in valid_options:
                ...
                print(Back.WHITE + Fore.BLACK + '\nGoalkeeper dives to:', directions[goalkeeper] + Style.RESET_ALL)
                ...
                print(Fore.RED + Back.WHITE + '\nYou stumbled on the keys, Please choose from lt, lb, mt, mb, rt, rb\n' + Style.RESET_ALL)
